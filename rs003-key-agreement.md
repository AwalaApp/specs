...
relaynetBiChannelSession OBJECT IDENTIFIER ::= {
    joint-iso-itu-t(2) uuid(25) relaynet(334996391340098037232342464294822053250) 1
    }
```
...
- `keyEncryptionAlgorithm`: The algorithm identified by [its OID](#object-identifier-oid). The ASN.1 representation of this identifier is shown below:
  ```
  relaynetBiChannelSessionIdentifier  AlgorithmIdentifier  ::=  {
    relaynetBiChannelSession,
    NULL
    }
  ```
